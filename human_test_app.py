...
st.info("⚖️ **رضایت‌نامه پژوهشی:** نتیجه این تست و تمام اطلاعاتی که وارد می‌کنید، با رضایت شما به صورت عمومی  در راستای اهداف پژوهشی و علمی قابل استفاده و انتشار است.")
