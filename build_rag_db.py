...
# چون دیتای ما فارسی است، از یک مدل چندزبانه (Multilingual) استفاده می‌کنیم
emb_fn = embedding_functions.SentenceTransformerEmbeddingFunction(
    # Uses a 12-layer neural network to convert multilingual text into 384-dimensional vectors (float scores) for semantic paraphrase detection.
